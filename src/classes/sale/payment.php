...
class Payment extends Bitrix24Entity
{
    /**
...
/*    public function fields()
 ...
 /*   public function get($dealId)
     ...
     * @return array
     */
    public function getList($select = array(), $filter = array(), $order = array(), $navigation = 0)
    {
        $fullResult = $this->client->call(
            'sale.payment.list',
            array(
     ...
     * @return array
     */
    public function update($paymentId, $paymentFields)
    {
        $fullResult = $this->client->call(
            'sale.payment.update',
            array(
